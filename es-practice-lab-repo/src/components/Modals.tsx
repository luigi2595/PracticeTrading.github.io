      ...
      <div className="modal-card">
        ...
        <div className="modal-body">
          ...
          <ul className="wl">
            ...
            <li><span className="n">4</span><span><b>Prop firm evaluation mode</b> (Settings) — turn on a trailing drawdown, a profit target, a daily loss limit and a consistency rule, and the sim enforces them while you trade, so a rule violation costs you nothing here instead of a paid attempt.</span></li>
          </ul>
          <p className="fine">The price data is synthetic — built to move like an intraday session, but it is not the real ES and contains no real news. Treat this as practice for execution and risk habits, not as a place to discover a strategy. Nothing here is trading advice, and futures can lose more than you deposit. Your journal is saved on your own device and is not shared with anyone. This app is independent, practice software: it is not affiliated with, endorsed by, or sponsored by any proprietary trading firm, and nothing in it is a real funded account or a submission to any evaluation program.<br /><br />HYPOTHETICAL OR SIMULATED PERFORMANCE RESULTS HAVE CERTAIN INHERENT LIMITATIONS. UNLIKE AN ACTUAL PERFORMANCE RECORD, SIMULATED RESULTS DO NOT REPRESENT ACTUAL TRADING. SINCE THE TRADES HAVE NOT ACTUALLY BEEN EXECUTED, THE RESULTS MAY HAVE UNDER- OR OVER-COMPENSATED FOR THE IMPACT OF CERTAIN MARKET FACTORS, SUCH AS LACK OF LIQUIDITY. NO REPRESENTATION IS BEING MADE THAT ANY ACCOUNT WILL OR IS LIKELY TO ACHIEVE PROFIT OR LOSSES SIMILAR TO THOSE SHOWN.</p>
        </div>
